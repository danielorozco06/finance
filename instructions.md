...
PROMPT: Actualizar para cada acción el archivo ./output/analysis/$TICKER.md con las siguientes secciones: catalizadores futuros, precio de compra/venta, recomendacion de inversion (0-6 meses, 6-12 meses y 12-18 meses), niveles tecnicos relevantes, estrategia recomendada. Nota: no incluir dividendos.
